...
def record_datatype_and_format_file(df, des_filename):
...
for day in day_list:
    ...
    # 保存DataFrame
    result_dir = "e:/log_test"
    dest_dir = "/".join([result_dir, "data"])
...
total_result_path = result_dir + "/total_result.xlsx"
df_all.to_excel(total_result_path)

record_datatype_and_format_file(df_all, des_filename)
